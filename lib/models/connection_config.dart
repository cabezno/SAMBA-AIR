...
class SblConfig {
  final String host;
  final int    port;
  const SblConfig({required this.host, required this.port});
}
...
class ConnectionConfig {
  ...
  /// Create an SBL config from manual IP entry
  static ConnectionConfig fromSblIp(String ip, {int port = 8890}) => ConnectionConfig(
    host: 'Manual',
    sbl:  SblConfig(host: ip, port: port),
  );
}
